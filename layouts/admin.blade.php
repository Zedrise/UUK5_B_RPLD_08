...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="nav-links">
            ...
            <a class="nav-link {{ request()->is('admin/jadwal*') ? 'active' : '' }}"
               href="{{ url('/admin/jadwal') }}" aria-label="Jadwal Kereta">
                <i class='bx bx-train'></i> Jadwal Kereta
            </a>

            <a class="nav-link {{ request()->is('admin/pesanan*') ? 'active' : '' }}"
               href="{{ url('/admin/pesanan') }}" aria-label="Pesanan">
                <i class='bx bx-receipt'></i> Pesanan
            </a>

            <a class="nav-link {{ request()->is('admin/users*') ? 'active' : '' }}"
               href="{{ url('/admin/users') }}" aria-label="Pengguna">
                <i class='bx bx-user'></i> Pengguna
            </a>
        </div>
    ...
    <script src="{{ asset('js/Ly-admin.js') }}"></script>
